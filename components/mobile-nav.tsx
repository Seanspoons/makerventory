      ...
      <div className="flex items-center justify-between gap-3 rounded-[24px] border border-slate-200/80 bg-white/90 px-3 py-3 shadow-[0_20px_60px_rgba(15,23,42,0.08)] backdrop-blur sm:px-4">
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          <Dialog>
            ...
            <DialogContent
              showClose={false}
              className="mobile-nav-dialog-motion left-auto right-2 top-2 w-[calc(100vw-1rem)] max-w-sm translate-x-0 translate-y-0 rounded-[28px] border-none bg-transparent p-0 shadow-none sm:right-4 sm:top-4 sm:w-[calc(100vw-2rem)]"
            >
